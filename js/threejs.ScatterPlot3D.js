...
renderer.setClearColorHex(0x232323, 1.0);
...
var xAxisMat = new THREE.LineBasicMaterial({color: 0x999999, lineWidth: 1});
var xAxis = new THREE.Line(xAxisGeo, xAxisMat);
xAxis.type = THREE.Lines;
scatterPlot.add(xAxis);

var yAxisMat = new THREE.LineBasicMaterial({color: 0x999999, lineWidth: 1});
var yAxis = new THREE.Line(yAxisGeo, yAxisMat);
      yAxis.type = THREE.Lines;
      scatterPlot.add(yAxis);
      
var zAxisMat = new THREE.LineBasicMaterial({color: 0x999999, lineWidth: 1});
var zAxis = new THREE.Line(zAxisGeo, zAxisMat);
zAxis.type = THREE.Lines;
scatterPlot.add(zAxis);

var boundaryMat = new THREE.LineBasicMaterial({color: 0x999999, lineWidth: 1, transparent: true});
...
for (i=0; i<csv.data.length; i++)
{
  ...
  var c = new THREE.Color().setRGB(.75,.75,.75)
